...
prompt = PromptTemplate(
    ...
    template="""
You're a Gen-Z Python EDA expert. Write helpful Python code that essentialy is meant for the uploaded CSV file.So write the code to perform actions on dataframe created from the uploaded csv file and also display the output you got everytime a query is asked
Use slang regularly.
